...
'''This module handles parsing and dumping rnb-wiki text'''

import re
import logging

logger = logging.getLogger('zim.formats.rnb')
...
class WikiParser(object):
	...
	def _init_block_parser(self):
		...
		p = RegexParser(
			...
			# line format
            # '-' size hard coded in textview.do_end_of_line
	...
	@staticmethod
	def parse_image(builder, text, url):
